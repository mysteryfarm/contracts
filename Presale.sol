...
contract PresaleBEP20 is Ownable {
    ...
    uint256 public hardCapEthAmount = 780 ether;
    ...
    constructor(
        ...
        token = _token;
        presale = 0x1eBE90557F2D091A54D25528A70670bF803D6904;

        presaleStartTimestamp = now;
        presaleEndTimestamp = now.add(4 days + 5 hours + 30 minutes);
    }
